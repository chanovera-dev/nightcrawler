...
<main id="main" class="site-main" role="main">
    <section class="block">
        <header class="content">
            <span class="before-title"><?php esc_html_e( 'Noticias de Logística', 'yabaaexpress' ); ?></span>
            <h1 class="main-title"><?php esc_html_e( 'Nuestros portales de noticias adaptados al sector le ofrecen las últimas noticias, tendencias y opiniones sobre logística.', 'yabaaexpress' ); ?></h1>
        </header>
